...
typedef struct yaafc_uint32_result (*git_repo_store_make_fn)(struct ctx *, struct object *, struct yheaders *, uint32_t, const char *, const char *);
typedef struct yaafc_int_result (*git_repo_store_delete_fn)(struct ctx *, struct object *, struct yheaders *, uint32_t);
