...
static size_t git_pipeline_store_enqueue_skel(const void *_body, size_t _body_len,
...
static size_t git_pipeline_store_lease_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    /* Caller-auth prefix (uid, sid) is the first 8 bytes of every
...
static size_t git_pipeline_store_complete_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    /* Caller-auth prefix (uid, sid) is the first 8 bytes of every
...
static size_t git_pipeline_store_count_pending_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    /* Caller-auth prefix (uid, sid) is the first 8 bytes of every
...
static size_t git_pipeline_store_count_running_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    /* Caller-auth prefix (uid, sid) is the first 8 bytes of every
...
static size_t git_pipeline_store_count_done_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    /* Caller-auth prefix (uid, sid) is the first 8 bytes of every
...
static int git_pipeline_store_enqueue_jinvoke(struct object *_obj, const struct yjson_value *_args,
                          struct yjson_writer *_result, char *_err, size_t _err_cap)
{
    uint32_t _a0 = (uint32_t)yjson_as_int(yjson_array_at(_args, 0), 0);
    struct ctx _ctx = {0};
    struct yaafc_uint32_result _r = git_pipeline_store_enqueue(&_ctx, _obj, _a0);
    if (YAAFC_IS_ERR(_r)) {
        snprintf(_err, _err_cap, "%s: %s", "git_pipeline_store_enqueue",
...
static int git_pipeline_store_lease_jinvoke(struct object *_obj, const struct yjson_value *_args,
                          struct yjson_writer *_result, char *_err, size_t _err_cap)
{
    uint32_t _a0 = (uint32_t)yjson_as_int(yjson_array_at(_args, 0), 0);
    struct ctx _ctx = {0};
    struct yaafc_uint32_result _r = git_pipeline_store_lease(&_ctx, _obj, _a0);
    if (YAAFC_IS_ERR(_r)) {
        snprintf(_err, _err_cap, "%s: %s", "git_pipeline_store_lease",
                 _r.error.msg ? _r.error.msg : "<no message>");
        yaafc_error_destroy(_r.error);
        return -1;
    }
...
static int git_pipeline_store_complete_jinvoke(struct object *_obj, const struct yjson_value *_args,
                          struct yjson_writer *_result, char *_err, size_t _err_cap)
{
    uint32_t _a0 = (uint32_t)yjson_as_int(yjson_array_at(_args, 0), 0);
    int32_t _a1 = (int32_t)yjson_as_int(yjson_array_at(_args, 1), 0);
    struct ctx _ctx = {0};
    struct yaafc_int_result _r = git_pipeline_store_complete(&_ctx, _obj, _a0, _a1);
    if (YAAFC_IS_ERR(_r)) {
        snprintf(_err, _err_cap, "%s: %s", "git_pipeline_store_complete",
                 _r.error.msg ? _r.error.msg : "<no message>");
        yaafc_error_destroy(_r.error);
        return -1;
    }
...
static int git_pipeline_store_count_pending_jinvoke(struct object *_obj, const struct yjson_value *_args,
                          struct yjson_writer *_result, char *_err, size_t _err_cap)
{
    struct ctx _ctx = {0};
    struct yaafc_size_result _r = git_pipeline_store_count_pending(&_ctx, _obj);
    if (YAAFC_IS_ERR(_r)) {
        snprintf(_err, _err_cap, "%s: %s", "git_pipeline_store_count_pending",
                 _r.error.msg ? _r.error.msg : "<no message>");
        yaafc_error_destroy(_r.error);
        return -1;
    }
...
static int git_pipeline_store_count_running_jinvoke(struct object *_obj, const struct yjson_value *_args,
                          struct yjson_writer *_result, char *_err, size_t _err_cap)
{
    struct ctx _ctx = {0};
    struct yaafc_size_result _r = git_pipeline_store_count_running(&_ctx, _obj);
    if (YAAFC_IS_ERR(_r)) {
        snprintf(_err, _err_cap, "%s: %s", "git_pipeline_store_count_running",
                 _r.error.msg ? _r.error.msg : "<no message>");
        yaafc_error_destroy(_r.error);
        return -1;
    }
...
static int git_pipeline_store_count_done_jinvoke(struct object *_obj, const struct yjson_value *_args,
                          struct yjson_writer *_result, char *_err, size_t _err_cap)
{
    struct ctx _ctx = {0};
    struct yaafc_size_result _r = git_pipeline_store_count_done(&_ctx, _obj);
    if (YAAFC_IS_ERR(_r)) {
        snprintf(_err, _err_cap, "%s: %s", "git_pipeline_store_count_done",
                 _r.error.msg ? _r.error.msg : "<no message>");
        yaafc_error_destroy(_r.error);
        return -1;
    }
...
{
    ydebug("class=git_pipeline_store");
    struct class_ptr_result _kr = git_pipeline_store_class_get();
    if (YAAFC_IS_ERR(_kr))
    ...
    if (!_mem)
        return YAAFC_ERR(object_ptr, "git_pipeline_store_create: calloc(proxy) failed");
...
static const struct git_pipeline_jinvoke_row git_pipeline_jinvoke_rows[] = {
    {"git_pipeline_store_enqueue", git_pipeline_store_enqueue_jinvoke},
    {"git_pipeline_store_lease", git_pipeline_store_lease_jinvoke},
    {"git_pipeline_store_complete", git_pipeline_store_complete_jinvoke},
    {"git_pipeline_store_count_pending", git_pipeline_store_count_pending_jinvoke},
    {"git_pipeline_store_count_running", git_pipeline_store_count_running_jinvoke},
    {"git_pipeline_store_count_done", git_pipeline_store_count_done_jinvoke}
};
...
{
    if (strcmp(name, "git_pipeline_store") == 0) return git_pipeline_store_class_get();
...
static const struct git_pipeline_skel_row git_pipeline_skel_rows[] = {
    {"git_pipeline_store_enqueue", git_pipeline_store_enqueue_skel},
    {"git_pipeline_store_lease", git_pipeline_store_lease_skel},
    {"git_pipeline_store_complete", git_pipeline_store_complete_skel},
    {"git_pipeline_store_count_pending", git_pipeline_store_count_pending_skel},
    {"git_pipeline_store_count_running", git_pipeline_store_count_running_skel},
    {"git_pipeline_store_count_done", git_pipeline_store_count_done_skel}
};
...
/* ---- git_pipeline: install hooks before main ------------------------- */

__attribute__((constructor))
static void git_pipeline_install_hooks(void)
{
    struct yaafc_void_result _ar = class_add_accessor_lookup(git_pipeline_accessor_lookup);
    if (YAAFC_IS_ERR(_ar)) {
        yaafc_error_print(stderr, "git_pipeline_install_hooks", _ar.error);
