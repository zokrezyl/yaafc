                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (PICOMESH_IS_ERR(_r)) {
        picomesh_error_print(stderr, "[skel] session_session_start", _r.error);
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_resp_max < 1) return 0;
    if (PICOMESH_IS_ERR(_r)) {
        picomesh_error_print(stderr, "[skel] session_session_jwt", _r.error);
        const char *_msg = _r.error.msg ? _r.error.msg : "(no msg)";
        uint32_t _ml = (uint32_t)strlen(_msg);
        if (_ml > 256) _ml = 256;
        if (_resp_max < 1 + 4 + _ml) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_resp_max < 1) return 0;
    if (PICOMESH_IS_ERR(_r)) {
        picomesh_error_print(stderr, "[skel] session_session_lookup", _r.error);
        const char *_msg = _r.error.msg ? _r.error.msg : "(no msg)";
        uint32_t _ml = (uint32_t)strlen(_msg);
        if (_ml > 256) _ml = 256;
        if (_resp_max < 1 + 4 + _ml) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_resp_max < 1) return 0;
    if (PICOMESH_IS_ERR(_r)) {
        picomesh_error_print(stderr, "[skel] session_session_destroy", _r.error);
        const char *_msg = _r.error.msg ? _r.error.msg : "(no msg)";
        uint32_t _ml = (uint32_t)strlen(_msg);
        if (_ml > 256) _ml = 256;
        if (_resp_max < 1 + 4 + _ml) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_resp_max < 1) return 0;
    if (PICOMESH_IS_ERR(_r)) {
        picomesh_error_print(stderr, "[skel] session_session_count_active", _r.error);
        const char *_msg = _r.error.msg ? _r.error.msg : "(no msg)";
        uint32_t _ml = (uint32_t)strlen(_msg);
        if (_ml > 256) _ml = 256;
        if (_resp_max < 1 + 4 + _ml) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_resp_max < 1) return 0;
    if (PICOMESH_IS_ERR(_r)) {
        picomesh_error_print(stderr, "[skel] session_session_list", _r.error);
        const char *_msg = _r.error.msg ? _r.error.msg : "(no msg)";
        uint32_t _ml = (uint32_t)strlen(_msg);
        if (_ml > 256) _ml = 256;
        if (_resp_max < 1 + 4 + _ml) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_resp_max < 1) return 0;
    if (PICOMESH_IS_ERR(_r)) {
        picomesh_error_print(stderr, "[skel] session_session_list_all", _r.error);
        const char *_msg = _r.error.msg ? _r.error.msg : "(no msg)";
        uint32_t _ml = (uint32_t)strlen(_msg);
        if (_ml > 256) _ml = 256;
        if (_resp_max < 1 + 4 + _ml) {
