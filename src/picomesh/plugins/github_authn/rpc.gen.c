...
static struct picomesh_size_result github_authn_github_authn_exchange_code_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    ...
    ytelemetry_server_span_begin(&_tsp, _hdrs, "skel.github_authn_github_authn_exchange_code");
    struct picomesh_json_result _r = github_authn_github_authn_exchange_code(&_local, _obj, _hdrs, _s1, _s2);
    ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r), PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
    yheaders_free(_hdrs); _hdrs = NULL;
    if (_resp_max < 1) return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_exchange_code_skel: response buffer too small");
    ...
    }
    {
        ...
        if (_resp_max < 1 + 4 + (size_t)_svlen) { free(_r.value); return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_exchange_code_skel: response buffer too small"); }
        ((uint8_t *)_resp)[0] = 0;
...
static struct picomesh_size_result github_authn_github_authn_set_credentials_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    struct ctx _local = {0};
    ...
    ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r), PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
    yheaders_free(_hdrs); _hdrs = NULL;
    if (_resp_max < 1) return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_set_credentials_skel: response buffer too small");
    if (PICOMESH_IS_ERR(_r)) {
        char _errbuf[8192] = {0};
        picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
        const char *_msg = _errbuf[0] ? _errbuf : (_r.error.msg ? _r.error.msg : "(no msg)");
    ...
    if (_resp_max < 1 + sizeof(_r.value)) return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_set_credentials_skel: response buffer too small");
    ((uint8_t *)_resp)[0] = 0;
...
static struct picomesh_size_result github_authn_github_authn_register_code_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    struct ctx _local = {0};
    ...
    ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r), PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
    yheaders_free(_hdrs); _hdrs = NULL;
    if (_resp_max < 1) return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_register_code_skel: response buffer too small");
    if (PICOMESH_IS_ERR(_r)) {
        char _errbuf[8192] = {0};
        picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
        const char *_msg = _errbuf[0] ? _errbuf : (_r.error.msg ? _r.error.msg : "(no msg)");
    ...
    if (_resp_max < 1 + sizeof(_r.value)) return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_register_code_skel: response buffer too small");
    ((uint8_t *)_resp)[0] = 0;
    memcpy((uint8_t *)_resp + 1, &_r.value, sizeof(_r.value));
    return PICOMESH_OK(picomesh_size, (size_t)(1 + sizeof(_r.value)));
_short_body:
...
static struct picomesh_size_result github_authn_github_authn_resolve_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    struct ctx _local = {0};
    ...
    ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r), PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
    yheaders_free(_hdrs); _hdrs = NULL;
    if (_resp_max < 1) return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_resolve_skel: response buffer too small");
    if (PICOMESH_IS_ERR(_r)) {
        char _errbuf[8192] = {0};
        picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
        const char *_msg = _errbuf[0] ? _errbuf : (_r.error.msg ? _r.error.msg : "(no msg)");
    ...
    if (_resp_max < 1 + sizeof(_r.value)) return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_resolve_skel: response buffer too small");
    ((uint8_t *)_resp)[0] = 0;
    memcpy((uint8_t *)_resp + 1, &_r.value, sizeof(_r.value));
    return PICOMESH_OK(picomesh_size, (size_t)(1 + sizeof(_r.value)));
_short_body:
...
static struct picomesh_size_result github_authn_github_authn_count_codes_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    struct ctx _local = {0};
    ...
    ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r), PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
    yheaders_free(_hdrs); _hdrs = NULL;
    if (_resp_max < 1) return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_count_codes_skel: response buffer too small");
    if (PICOMESH_IS_ERR(_r)) {
        char _errbuf[8192] = {0};
        picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
        const char *_msg = _errbuf[0] ? _errbuf : (_r.error.msg ? _r.error.msg : "(no msg)");
    ...
    if (_resp_max < 1 + sizeof(_r.value)) return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_count_codes_skel: response buffer too small");
    ((uint8_t *)_resp)[0] = 0;
    memcpy((uint8_t *)_resp + 1, &_r.value, sizeof(_r.value));
    return PICOMESH_OK(picomesh_size, (size_t)(1 + sizeof(_r.value)));
_short_body:
...
static struct picomesh_size_result github_authn_github_authn_list_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    struct ctx _local = {0};
    ...
    ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r), PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
    yheaders_free(_hdrs); _hdrs = NULL;
    if (_resp_max < 1) return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_list_skel: response buffer too small");
    if (PICOMESH_IS_ERR(_r)) {
        char _errbuf[8192] = {0};
        picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
        const char *_msg = _errbuf[0] ? _errbuf : (_r.error.msg ? _r.error.msg : "(no msg)");
    ...
    }
    {
        const char *_sv = _r.value ? _r.value : "";
        uint32_t _svlen = (uint32_t)strlen(_sv);
        if (_resp_max < 1 + 4 + (size_t)_svlen) { free(_r.value); return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_list_skel: response buffer too small"); }
        ((uint8_t *)_resp)[0] = 0;
        memcpy((uint8_t *)_resp + 1, &_svlen, 4);
        if (_svlen) memcpy((uint8_t *)_resp + 5, _sv, _svlen);
        free(_r.value);
...
static struct picomesh_size_result github_authn_github_authn_list_all_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    struct ctx _local = {0};
    ...
    ytelemetry_span_end(&_tsp, !PICOMESH_IS_ERR(_r), PICOMESH_IS_ERR(_r) ? _r.error.msg : NULL);
    yheaders_free(_hdrs); _hdrs = NULL;
    if (_resp_max < 1) return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_list_all_skel: response buffer too small");
    if (PICOMESH_IS_ERR(_r)) {
        char _errbuf[8192] = {0};
        picomesh_error_snprint(_errbuf, sizeof(_errbuf), _r.error);
        const char *_msg = _errbuf[0] ? _errbuf : (_r.error.msg ? _r.error.msg : "(no msg)");
    ...
    }
    {
        const char *_sv = _r.value ? _r.value : "";
        uint32_t _svlen = (uint32_t)strlen(_sv);
        if (_resp_max < 1 + 4 + (size_t)_svlen) { free(_r.value); return PICOMESH_ERR(picomesh_size, "github_authn_github_authn_list_all_skel: response buffer too small"); }
        ((uint8_t *)_resp)[0] = 0;
        memcpy((uint8_t *)_resp + 1, &_svlen, 4);
        if (_svlen) memcpy((uint8_t *)_resp + 5, _sv, _svlen);
        free(_r.value);
...
static struct picomesh_void_result github_authn_github_authn_exchange_code_jinvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, const struct json_value *args,
                          struct json_writer *result, char *err, size_t err_cap)
{
    yinfo("[rpc] github_authn_github_authn_exchange_code");
    const char *arg0 = json_as_string(json_array_at(args, 0), "");
    const char *arg1 = json_as_string(json_array_at(args, 1), "");
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
    struct picomesh_json_result call_result = github_authn_github_authn_exchange_code(call_ctx, obj, hdrs, arg0, arg1);
    if (PICOMESH_IS_ERR(call_result)) {
        char chain[8192] = {0};
        picomesh_error_snprint(chain, sizeof(chain), call_result.error);
        snprintf(err, err_cap, "%s: %s", "github_authn_github_authn_exchange_code",
                 chain[0] ? chain : (call_result.error.msg ? call_result.error.msg : "<no message>"));
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_exchange_code", call_result);
    }
...
static struct picomesh_void_result github_authn_github_authn_set_credentials_jinvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, const struct json_value *args,
                          struct json_writer *result, char *err, size_t err_cap)
{
    yinfo("[rpc] github_authn_github_authn_set_credentials");
    ...
    if (PICOMESH_IS_ERR(call_result)) {
        ...
        snprintf(err, err_cap, "%s: %s", "github_authn_github_authn_set_credentials",
                 chain[0] ? chain : (call_result.error.msg ? call_result.error.msg : "<no message>"));
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_set_credentials", call_result);
    }
    json_writer_int(result, (int64_t)call_result.value);
    return PICOMESH_OK_VOID();
}

static struct picomesh_void_result github_authn_github_authn_register_code_jinvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, const struct json_value *args,
                          struct json_writer *result, char *err, size_t err_cap)
{
    yinfo("[rpc] github_authn_github_authn_register_code");
    uint32_t arg0 = (uint32_t)json_as_int(json_array_at(args, 0), 0);
    uint32_t arg1 = (uint32_t)json_as_int(json_array_at(args, 1), 0);
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
    ...
    if (PICOMESH_IS_ERR(call_result)) {
        ...
        snprintf(err, err_cap, "%s: %s", "github_authn_github_authn_register_code",
                 chain[0] ? chain : (call_result.error.msg ? call_result.error.msg : "<no message>"));
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_register_code", call_result);
    }
    json_writer_int(result, (int64_t)call_result.value);
    return PICOMESH_OK_VOID();
}

static struct picomesh_void_result github_authn_github_authn_resolve_jinvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, const struct json_value *args,
                          struct json_writer *result, char *err, size_t err_cap)
{
    yinfo("[rpc] github_authn_github_authn_resolve");
    uint32_t arg0 = (uint32_t)json_as_int(json_array_at(args, 0), 0);
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
    ...
    if (PICOMESH_IS_ERR(call_result)) {
        ...
        snprintf(err, err_cap, "%s: %s", "github_authn_github_authn_resolve",
                 chain[0] ? chain : (call_result.error.msg ? call_result.error.msg : "<no message>"));
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_resolve", call_result);
    }
    json_writer_int(result, (int64_t)call_result.value);
    return PICOMESH_OK_VOID();
}

static struct picomesh_void_result github_authn_github_authn_count_codes_jinvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, const struct json_value *args,
                          struct json_writer *result, char *err, size_t err_cap)
{
    yinfo("[rpc] github_authn_github_authn_count_codes");
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
    ...
    if (PICOMESH_IS_ERR(call_result)) {
        ...
        snprintf(err, err_cap, "%s: %s", "github_authn_github_authn_count_codes",
                 chain[0] ? chain : (call_result.error.msg ? call_result.error.msg : "<no message>"));
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_count_codes", call_result);
    }
    json_writer_int(result, (int64_t)call_result.value);
    return PICOMESH_OK_VOID();
}

static struct picomesh_void_result github_authn_github_authn_list_jinvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, const struct json_value *args,
                          struct json_writer *result, char *err, size_t err_cap)
{
    yinfo("[rpc] github_authn_github_authn_list");
    ...
    if (PICOMESH_IS_ERR(call_result)) {
        ...
        snprintf(err, err_cap, "%s: %s", "github_authn_github_authn_list",
                 chain[0] ? chain : (call_result.error.msg ? call_result.error.msg : "<no message>"));
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_list", call_result);
    }
    json_writer_raw(result, call_result.value ? call_result.value : "null");
    free(call_result.value);
    return PICOMESH_OK_VOID();
...
static struct picomesh_void_result github_authn_github_authn_list_all_jinvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, const struct json_value *args,
                          struct json_writer *result, char *err, size_t err_cap)
{
    yinfo("[rpc] github_authn_github_authn_list_all");
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
    ...
    if (PICOMESH_IS_ERR(call_result)) {
        ...
        snprintf(err, err_cap, "%s: %s", "github_authn_github_authn_list_all",
                 chain[0] ? chain : (call_result.error.msg ? call_result.error.msg : "<no message>"));
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_list_all", call_result);
    }
    json_writer_raw(result, call_result.value ? call_result.value : "null");
    free(call_result.value);
    return PICOMESH_OK_VOID();
...
static struct picomesh_void_result github_authn_github_authn_exchange_code_minvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, cmp_ctx_t *_mr, uint32_t _argc,
                          cmp_ctx_t *_mw, char *_err, size_t _err_cap)
{
    (void)_mr;
    if (_argc != 2u) {
        snprintf(_err, _err_cap, "github_authn_github_authn_exchange_code: expected 2 arg(s), got %u", _argc);
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_exchange_code: wrong argument count");
    }
    char _v0[4096];
    {
        uint32_t _sz = (uint32_t)sizeof(_v0);
        if (!cmp_read_str(_mr, _v0, &_sz)) {
            snprintf(_err, _err_cap, "code: expected str arg (%s)", cmp_strerror(_mr));
    ...
    char _v1[4096];
    {
        ...
        if (!cmp_read_str(_mr, _v1, &_sz)) {
            snprintf(_err, _err_cap, "redirect_uri: expected str arg (%s)", cmp_strerror(_mr));
            return PICOMESH_ERR(picomesh_void, "minvoke: bad argument");
        }
    }
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
    struct picomesh_json_result call_result = github_authn_github_authn_exchange_code(call_ctx, obj, hdrs, _v0, _v1);
    if (PICOMESH_IS_ERR(call_result)) {
        char chain[8192] = {0};
        picomesh_error_snprint(chain, sizeof(chain), call_result.error);
        snprintf(_err, _err_cap, "%s: %s", "github_authn_github_authn_exchange_code",
                 chain[0] ? chain : (call_result.error.msg ? call_result.error.msg : "<no message>"));
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_exchange_code", call_result);
    }
    {
...
static struct picomesh_void_result github_authn_github_authn_set_credentials_minvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, cmp_ctx_t *_mr, uint32_t _argc,
                          cmp_ctx_t *_mw, char *_err, size_t _err_cap)
{
    (void)_mr;
    if (_argc != 2u) {
        ...
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_set_credentials: wrong argument count");
    }
    uint32_t _v0;
    {
        uint64_t _u;
        if (!cmp_read_uinteger(_mr, &_u)) { snprintf(_err, _err_cap, "client_id: expected unsigned int (%s)", cmp_strerror(_mr)); return PICOMESH_ERR(picomesh_void, "minvoke: bad argument"); }
        if (_u > UINT32_MAX) { snprintf(_err, _err_cap, "client_id: value %llu out of range for uint32_t", (unsigned long long)_u); return PICOMESH_ERR(picomesh_void, "minvoke: bad argument"); }
        _v0 = (uint32_t)_u;
    }
    uint32_t _v1;
    {
        uint64_t _u;
        if (!cmp_read_uinteger(_mr, &_u)) { snprintf(_err, _err_cap, "secret_id: expected unsigned int (%s)", cmp_strerror(_mr)); return PICOMESH_ERR(picomesh_void, "minvoke: bad argument"); }
        if (_u > UINT32_MAX) { snprintf(_err, _err_cap, "secret_id: value %llu out of range for uint32_t", (unsigned long long)_u); return PICOMESH_ERR(picomesh_void, "minvoke: bad argument"); }
        _v1 = (uint32_t)_u;
    }
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
...
static struct picomesh_void_result github_authn_github_authn_register_code_minvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, cmp_ctx_t *_mr, uint32_t _argc,
                          cmp_ctx_t *_mw, char *_err, size_t _err_cap)
{
    (void)_mr;
    if (_argc != 2u) {
        ...
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_register_code: wrong argument count");
    }
    uint32_t _v0;
    {
        uint64_t _u;
        if (!cmp_read_uinteger(_mr, &_u)) { snprintf(_err, _err_cap, "code: expected unsigned int (%s)", cmp_strerror(_mr)); return PICOMESH_ERR(picomesh_void, "minvoke: bad argument"); }
        if (_u > UINT32_MAX) { snprintf(_err, _err_cap, "code: value %llu out of range for uint32_t", (unsigned long long)_u); return PICOMESH_ERR(picomesh_void, "minvoke: bad argument"); }
        _v0 = (uint32_t)_u;
    }
    uint32_t _v1;
    {
...
static struct picomesh_void_result github_authn_github_authn_resolve_minvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, cmp_ctx_t *_mr, uint32_t _argc,
                          cmp_ctx_t *_mw, char *_err, size_t _err_cap)
{
    (void)_mr;
    if (_argc != 1u) {
        ...
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_resolve: wrong argument count");
    }
    uint32_t _v0;
    {
        uint64_t _u;
...
static struct picomesh_void_result github_authn_github_authn_count_codes_minvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, cmp_ctx_t *_mr, uint32_t _argc,
                          cmp_ctx_t *_mw, char *_err, size_t _err_cap)
{
    (void)_mr;
    if (_argc != 0u) {
        ...
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_count_codes: wrong argument count");
    }
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
    struct picomesh_size_result call_result = github_authn_github_authn_count_codes(call_ctx, obj, hdrs);
...
static struct picomesh_void_result github_authn_github_authn_list_minvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, cmp_ctx_t *_mr, uint32_t _argc,
                          cmp_ctx_t *_mw, char *_err, size_t _err_cap)
{
    (void)_mr;
    if (_argc != 2u) {
        ...
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_list: wrong argument count");
    }
    int64_t _v0;
...
static struct picomesh_void_result github_authn_github_authn_list_all_minvoke(struct ctx *ctx, struct object *obj,
                          struct yheaders *hdrs, cmp_ctx_t *_mr, uint32_t _argc,
                          cmp_ctx_t *_mw, char *_err, size_t _err_cap)
{
    (void)_mr;
    if (_argc != 0u) {
        ...
        return PICOMESH_ERR(picomesh_void, "github_authn_github_authn_list_all: wrong argument count");
    }
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
    struct picomesh_json_result call_result = github_authn_github_authn_list_all(call_ctx, obj, hdrs);
...
static const struct github_authn_jinvoke_row github_authn_jinvoke_rows[] = {
    {"github_authn_github_authn_exchange_code", github_authn_github_authn_exchange_code_jinvoke},
...
{
    for (size_t i = 0;
         i < sizeof(github_authn_jinvoke_rows) / sizeof(github_authn_jinvoke_rows[0]); ++i)
        if (strcmp(github_authn_jinvoke_rows[i].name, qname) == 0)
...
static const struct github_authn_minvoke_row github_authn_minvoke_rows[] = {
    {"github_authn_github_authn_exchange_code", github_authn_github_authn_exchange_code_minvoke},
...
static const struct jinvoke_param github_authn_github_authn_exchange_code_params[] = {
    {"code", "const char *"},
...
static const struct github_authn_params_row github_authn_params_rows[] = {
    {"github_authn_github_authn_exchange_code", {github_authn_github_authn_exchange_code_params, 2}},
...
/* ---- github_authn: slot → skel, name-keyed static data --------------- */
...
static const struct github_authn_skel_row github_authn_skel_rows[] = {
    {"github_authn_github_authn_exchange_code", github_authn_github_authn_exchange_code_skel},
...
static rpc_skel_fn github_authn_skel_lookup(const char *name)
{
    ...
    for (size_t i = 0; i < sizeof(github_authn_skel_rows) / sizeof(github_authn_skel_rows[0]); ++i)
        if (strcmp(github_authn_skel_rows[i].name, name) == 0)
            return github_authn_skel_rows[i].fn;
    return NULL;
}

/* ---- github_authn: registration entry point (called from the driver for
...
{
    struct picomesh_void_result _ar = class_add_accessor_lookup(github_authn_accessor_lookup);
    PICOMESH_RETURN_IF_ERR(picomesh_void, _ar,
                           "picomesh_plugin_github_authn_register: add accessor lookup");
    ...
    { struct class_ptr_result reg = github_authn_github_authn_class_get();
      PICOMESH_RETURN_IF_ERR(picomesh_void, reg, "github_authn register: prewarm github_authn_github_authn_class_get"); }
    return PICOMESH_OK_VOID();
}
