...
static size_t token_issuer_token_issuer_login_skel(const void *_body, size_t _body_len,
...
static size_t token_issuer_token_issuer_refresh_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    struct ctx _local = {0};
...
static size_t token_issuer_token_issuer_mint_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    struct ctx _local = {0};
...
static size_t token_issuer_token_issuer_count_active_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    struct ctx _local = {0};
...
static size_t token_issuer_token_issuer_list_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    struct ctx _local = {0};
...
static size_t token_issuer_token_issuer_list_all_skel(const void *_body, size_t _body_len,
                          void *_resp, size_t _resp_max)
{
    size_t _off = 0;
    struct ctx _local = {0};
...
static int token_issuer_token_issuer_login_jinvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
...
static int token_issuer_token_issuer_refresh_jinvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                          const struct yjson_value *args,
                          struct yjson_writer *result, char *err, size_t err_cap)
{
    const char *arg0 = yjson_as_string(yjson_array_at(args, 0), "");
...
static int token_issuer_token_issuer_mint_jinvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                          const struct yjson_value *args,
                          struct yjson_writer *result, char *err, size_t err_cap)
{
...
static int token_issuer_token_issuer_count_active_jinvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                          const struct yjson_value *args,
                          struct yjson_writer *result, char *err, size_t err_cap)
{
    struct ctx local_ctx = {0};
...
static int token_issuer_token_issuer_list_jinvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                          const struct yjson_value *args,
                          struct yjson_writer *result, char *err, size_t err_cap)
{
...
static int token_issuer_token_issuer_list_all_jinvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                          const struct yjson_value *args,
                          struct yjson_writer *result, char *err, size_t err_cap)
{
    struct ctx local_ctx = {0};
...
static int token_issuer_token_issuer_login_minvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                          ...
                          char *_err, size_t _err_cap)
{
    ...
    int64_t _v3;
    if (!cmp_read_integer(_mr, &_v3)) { snprintf(_err, _err_cap, "pw_hash: expected int (%s)", cmp_strerror(_mr)); return -1; }
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
...
static int token_issuer_token_issuer_refresh_minvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                          cmp_ctx_t *_mr, uint32_t _argc, cmp_ctx_t *_mw,
                          char *_err, size_t _err_cap)
{
    (void)_mr;
...
static int token_issuer_token_issuer_mint_minvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                          cmp_ctx_t *_mr, uint32_t _argc, cmp_ctx_t *_mw,
                          char *_err, size_t _err_cap)
{
    (void)_mr;
    ...
    int64_t _v3;
    if (!cmp_read_integer(_mr, &_v3)) { snprintf(_err, _err_cap, "ttl_seconds: expected int (%s)", cmp_strerror(_mr)); return -1; }
    struct ctx local_ctx = {0};
    struct ctx *call_ctx = ctx ? ctx : &local_ctx;
...
static int token_issuer_token_issuer_count_active_minvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                          cmp_ctx_t *_mr, uint32_t _argc, cmp_ctx_t *_mw,
                          char *_err, size_t _err_cap)
{
    (void)_mr;
...
static int token_issuer_token_issuer_list_minvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                          cmp_ctx_t *_mr, uint32_t _argc, cmp_ctx_t *_mw,
                          char *_err, size_t _err_cap)
{
    (void)_mr;
...
static int token_issuer_token_issuer_list_all_minvoke(struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
                          cmp_ctx_t *_mr, uint32_t _argc, cmp_ctx_t *_mw,
                          char *_err, size_t _err_cap)
{
    (void)_mr;
...
static const struct jinvoke_param token_issuer_token_issuer_login_params[] = {
    {"method", "const char *"},
    {"uid", "uint32_t"},
    {"username", "const char *"},
    {"pw_hash", "int64_t"}
...
void picomesh_plugin_token_issuer_register(void)
{
    ...
    if (PICOMESH_IS_ERR(_ar)) {
        picomesh_error_print(stderr, "picomesh_plugin_token_issuer_register", _ar.error);
