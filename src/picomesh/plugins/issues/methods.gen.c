...
struct picomesh_uint32_result issues_issues_open(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, uint32_t repo_id, uint32_t author_id)
{
    ...
    if (_s && _s->peer) {
        if (peer_channel_is_msgpack(_s->peer)) {
            ...
            if (!peer_channel_msgpack_call(_s->peer, "issues.issues.open", hdrs,
                ...
                _mret = _merr[0]
                            ...
                            : PICOMESH_ERR(picomesh_uint32, "issues_issues_open: msgpack call failed");
            } else {
        ...
        if (PICOMESH_IS_ERR(_rid_res))
            return PICOMESH_ERR(picomesh_uint32, "issues_issues_open: ensure remote id failed", _rid_res);
        ...
        if (!_a || !_wbuf) {
            ...
            return PICOMESH_ERR(picomesh_uint32, "issues_issues_open: wire scratch alloc failed");
        }
        size_t _off = 0;
         ...
         * this client span's id as parent_span_id across the serialize. */
        {
            ...
            if (_hn == 0) {
                ...
                _ret = PICOMESH_ERR(picomesh_uint32, "issues_issues_open: header serialize overflow");
                goto _rpc_done;
            }
            _off = _hn;
        }
        {
            ...
            if (_off + 8 > _acap)
                { ytelemetry_span_end(&_tsp, 0, "issues_issues_open: pack overflow"); _ret = PICOMESH_ERR(picomesh_uint32, "issues_issues_open: pack overflow"); goto _rpc_done; }
            memcpy(_a + _off, &_h, 8); _off += 8;
        }
        if (_off + sizeof(repo_id) > _acap)
            { ytelemetry_span_end(&_tsp, 0, "issues_issues_open: pack overflow"); _ret = PICOMESH_ERR(picomesh_uint32, "issues_issues_open: pack overflow"); goto _rpc_done; }
        memcpy(_a + _off, &repo_id, sizeof(repo_id)); _off += sizeof(repo_id);
        if (_off + sizeof(author_id) > _acap)
            { ytelemetry_span_end(&_tsp, 0, "issues_issues_open: pack overflow"); _ret = PICOMESH_ERR(picomesh_uint32, "issues_issues_open: pack overflow"); goto _rpc_done; }
        memcpy(_a + _off, &author_id, sizeof(author_id)); _off += sizeof(author_id);
        size_t _wn = rpc_call(_s->peer, RPC_OP_CALL, _rid, _a, _off,
                              _wbuf, 8197);
        ytelemetry_span_end(&_tsp, _wn >= 1 && _wbuf[0] == 0, NULL);
        if (_wn < 1) { _ret = PICOMESH_ERR(picomesh_uint32, "issues_issues_open: short RPC response"); goto _rpc_done; }
        if (_wbuf[0] != 0) {
            uint32_t _msg_len = 0;
            ...
            _ret = _msg[0]
                       ...
                       : PICOMESH_ERR(picomesh_uint32, "issues_issues_open: remote error (no msg)");
            goto _rpc_done;
        }
        if (_wn != 1 + sizeof(uint32_t)) { _ret = PICOMESH_ERR(picomesh_uint32, "issues_issues_open: truncated RPC payload"); goto _rpc_done; }
        uint32_t _v;
...
struct picomesh_int_result issues_issues_close(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, uint32_t issue_id)
{
    ...
    if (_s && _s->peer) {
        if (peer_channel_is_msgpack(_s->peer)) {
            ...
            if (!peer_channel_msgpack_call(_s->peer, "issues.issues.close", hdrs,
                ...
                _mret = _merr[0]
                            ...
                            : PICOMESH_ERR(picomesh_int, "issues_issues_close: msgpack call failed");
            } else {
                struct picomesh_msgpack_buffer _mrb;
                cmp_ctx_t _mrr;
                picomesh_msgpack_reader_init(&_mrr, &_mrb, _mresp, _mrlen);
        ...
        struct picomesh_uint32_result _rid_res = peer_channel_ensure_remote_id(_s->peer, _slot);
        if (PICOMESH_IS_ERR(_rid_res))
            return PICOMESH_ERR(picomesh_int, "issues_issues_close: ensure remote id failed", _rid_res);
        uint32_t _rid = _rid_res.value;
        if (_rid == RPC_REMOTE_ID_UNRESOLVED)
        ...
        if (!_a || !_wbuf) {
            picomesh_allocator_free(_pool, _a);
            picomesh_allocator_free(_pool, _wbuf);
            return PICOMESH_ERR(picomesh_int, "issues_issues_close: wire scratch alloc failed");
        }
        size_t _off = 0;
        /* Client span for this downstream call. Minted BEFORE the header
         * bag is serialized so the wire carries this span as the remote
         ...
         * this client span's id as parent_span_id across the serialize. */
        {
            ...
            if (_hn == 0) {
                ...
                _ret = PICOMESH_ERR(picomesh_int, "issues_issues_close: header serialize overflow");
                goto _rpc_done;
            }
            _off = _hn;
        }
        {
            uint64_t _h = *(uint64_t *)((char *)obj + sizeof(*obj));
            if (_off + 8 > _acap)
                { ytelemetry_span_end(&_tsp, 0, "issues_issues_close: pack overflow"); _ret = PICOMESH_ERR(picomesh_int, "issues_issues_close: pack overflow"); goto _rpc_done; }
            memcpy(_a + _off, &_h, 8); _off += 8;
        }
        if (_off + sizeof(issue_id) > _acap)
            { ytelemetry_span_end(&_tsp, 0, "issues_issues_close: pack overflow"); _ret = PICOMESH_ERR(picomesh_int, "issues_issues_close: pack overflow"); goto _rpc_done; }
        memcpy(_a + _off, &issue_id, sizeof(issue_id)); _off += sizeof(issue_id);
        size_t _wn = rpc_call(_s->peer, RPC_OP_CALL, _rid, _a, _off,
                              _wbuf, 8197);
        ytelemetry_span_end(&_tsp, _wn >= 1 && _wbuf[0] == 0, NULL);
        if (_wn < 1) { _ret = PICOMESH_ERR(picomesh_int, "issues_issues_close: short RPC response"); goto _rpc_done; }
        if (_wbuf[0] != 0) {
            uint32_t _msg_len = 0;
            if (_wn >= 5) memcpy(&_msg_len, _wbuf + 1, 4);
            char _msg[8193];
            ...
            _ret = _msg[0]
                       ...
                       : PICOMESH_ERR(picomesh_int, "issues_issues_close: remote error (no msg)");
            goto _rpc_done;
        }
        if (_wn != 1 + sizeof(int)) { _ret = PICOMESH_ERR(picomesh_int, "issues_issues_close: truncated RPC payload"); goto _rpc_done; }
        int _v;
        memcpy(&_v, _wbuf + 1, sizeof(_v));
    ...
    if (_s && _s->peer) {
        if (peer_channel_is_msgpack(_s->peer)) {
            ...
            if (!peer_channel_msgpack_call(_s->peer, "issues.issues.status", hdrs,
                ...
                _mret = _merr[0]
                            ? PICOMESH_ERR_OWNED(picomesh_int, strdup(_merr))
                            : PICOMESH_ERR(picomesh_int, "issues_issues_status: msgpack call failed");
            } else {
                struct picomesh_msgpack_buffer _mrb;
                cmp_ctx_t _mrr;
                picomesh_msgpack_reader_init(&_mrr, &_mrb, _mresp, _mrlen);
        ...
        struct picomesh_uint32_result _rid_res = peer_channel_ensure_remote_id(_s->peer, _slot);
        if (PICOMESH_IS_ERR(_rid_res))
            return PICOMESH_ERR(picomesh_int, "issues_issues_status: ensure remote id failed", _rid_res);
        uint32_t _rid = _rid_res.value;
        if (_rid == RPC_REMOTE_ID_UNRESOLVED)
        ...
        if (!_a || !_wbuf) {
            picomesh_allocator_free(_pool, _a);
            picomesh_allocator_free(_pool, _wbuf);
            return PICOMESH_ERR(picomesh_int, "issues_issues_status: wire scratch alloc failed");
        }
        size_t _off = 0;
        /* Client span for this downstream call. Minted BEFORE the header
         * bag is serialized so the wire carries this span as the remote
         ...
         * this client span's id as parent_span_id across the serialize. */
        {
            ...
            if (_hn == 0) {
                ...
                _ret = PICOMESH_ERR(picomesh_int, "issues_issues_status: header serialize overflow");
                goto _rpc_done;
            }
            _off = _hn;
        }
        {
            uint64_t _h = *(uint64_t *)((char *)obj + sizeof(*obj));
            if (_off + 8 > _acap)
                { ytelemetry_span_end(&_tsp, 0, "issues_issues_status: pack overflow"); _ret = PICOMESH_ERR(picomesh_int, "issues_issues_status: pack overflow"); goto _rpc_done; }
            memcpy(_a + _off, &_h, 8); _off += 8;
        }
        if (_off + sizeof(issue_id) > _acap)
            { ytelemetry_span_end(&_tsp, 0, "issues_issues_status: pack overflow"); _ret = PICOMESH_ERR(picomesh_int, "issues_issues_status: pack overflow"); goto _rpc_done; }
        ...
        size_t _wn = rpc_call(_s->peer, RPC_OP_CALL, _rid, _a, _off,
                              _wbuf, 8197);
        ytelemetry_span_end(&_tsp, _wn >= 1 && _wbuf[0] == 0, NULL);
        if (_wn < 1) { _ret = PICOMESH_ERR(picomesh_int, "issues_issues_status: short RPC response"); goto _rpc_done; }
        if (_wbuf[0] != 0) {
            uint32_t _msg_len = 0;
            if (_wn >= 5) memcpy(&_msg_len, _wbuf + 1, 4);
            char _msg[8193];
            ...
            _ret = _msg[0]
                       ? PICOMESH_ERR_OWNED(picomesh_int, strdup(_msg))
                       : PICOMESH_ERR(picomesh_int, "issues_issues_status: remote error (no msg)");
            goto _rpc_done;
        }
        if (_wn != 1 + sizeof(int)) { _ret = PICOMESH_ERR(picomesh_int, "issues_issues_status: truncated RPC payload"); goto _rpc_done; }
        int _v;
        memcpy(&_v, _wbuf + 1, sizeof(_v));
        _ret = PICOMESH_OK(picomesh_int, _v); goto _rpc_done;
    _rpc_done:
...
struct picomesh_size_result issues_issues_count_open_in_repo(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, uint32_t repo_id)
{
    ...
    if (_s && _s->peer) {
        if (peer_channel_is_msgpack(_s->peer)) {
            ...
            if (!peer_channel_msgpack_call(_s->peer, "issues.issues.count_open_in_repo", hdrs,
                ...
                _mret = _merr[0]
                            ...
                            : PICOMESH_ERR(picomesh_size, "issues_issues_count_open_in_repo: msgpack call failed");
            } else {
                struct picomesh_msgpack_buffer _mrb;
                cmp_ctx_t _mrr;
                picomesh_msgpack_reader_init(&_mrr, &_mrb, _mresp, _mrlen);
        ...
        struct picomesh_uint32_result _rid_res = peer_channel_ensure_remote_id(_s->peer, _slot);
        if (PICOMESH_IS_ERR(_rid_res))
            return PICOMESH_ERR(picomesh_size, "issues_issues_count_open_in_repo: ensure remote id failed", _rid_res);
        uint32_t _rid = _rid_res.value;
        if (_rid == RPC_REMOTE_ID_UNRESOLVED)
        ...
        if (!_a || !_wbuf) {
            picomesh_allocator_free(_pool, _a);
            picomesh_allocator_free(_pool, _wbuf);
            return PICOMESH_ERR(picomesh_size, "issues_issues_count_open_in_repo: wire scratch alloc failed");
        }
        size_t _off = 0;
        /* Client span for this downstream call. Minted BEFORE the header
         * bag is serialized so the wire carries this span as the remote
         ...
         * this client span's id as parent_span_id across the serialize. */
        {
            ...
            if (_hn == 0) {
                ...
                _ret = PICOMESH_ERR(picomesh_size, "issues_issues_count_open_in_repo: header serialize overflow");
                goto _rpc_done;
            }
            _off = _hn;
        }
        {
            uint64_t _h = *(uint64_t *)((char *)obj + sizeof(*obj));
            if (_off + 8 > _acap)
                { ytelemetry_span_end(&_tsp, 0, "issues_issues_count_open_in_repo: pack overflow"); _ret = PICOMESH_ERR(picomesh_size, "issues_issues_count_open_in_repo: pack overflow"); goto _rpc_done; }
            memcpy(_a + _off, &_h, 8); _off += 8;
        }
        if (_off + sizeof(repo_id) > _acap)
            { ytelemetry_span_end(&_tsp, 0, "issues_issues_count_open_in_repo: pack overflow"); _ret = PICOMESH_ERR(picomesh_size, "issues_issues_count_open_in_repo: pack overflow"); goto _rpc_done; }
        ...
        size_t _wn = rpc_call(_s->peer, RPC_OP_CALL, _rid, _a, _off,
                              _wbuf, 8197);
        ytelemetry_span_end(&_tsp, _wn >= 1 && _wbuf[0] == 0, NULL);
        if (_wn < 1) { _ret = PICOMESH_ERR(picomesh_size, "issues_issues_count_open_in_repo: short RPC response"); goto _rpc_done; }
        if (_wbuf[0] != 0) {
            uint32_t _msg_len = 0;
            if (_wn >= 5) memcpy(&_msg_len, _wbuf + 1, 4);
            char _msg[8193];
            ...
            _ret = _msg[0]
                       ...
                       : PICOMESH_ERR(picomesh_size, "issues_issues_count_open_in_repo: remote error (no msg)");
            goto _rpc_done;
        }
        if (_wn != 1 + sizeof(size_t)) { _ret = PICOMESH_ERR(picomesh_size, "issues_issues_count_open_in_repo: truncated RPC payload"); goto _rpc_done; }
        size_t _v;
        memcpy(&_v, _wbuf + 1, sizeof(_v));
    ...
    if (_s && _s->peer) {
        if (peer_channel_is_msgpack(_s->peer)) {
            ...
            if (!peer_channel_msgpack_call(_s->peer, "issues.issues.count_total", hdrs,
                ...
                _mret = _merr[0]
                            ? PICOMESH_ERR_OWNED(picomesh_size, strdup(_merr))
                            : PICOMESH_ERR(picomesh_size, "issues_issues_count_total: msgpack call failed");
            } else {
                struct picomesh_msgpack_buffer _mrb;
                cmp_ctx_t _mrr;
                picomesh_msgpack_reader_init(&_mrr, &_mrb, _mresp, _mrlen);
        ...
        struct picomesh_uint32_result _rid_res = peer_channel_ensure_remote_id(_s->peer, _slot);
        if (PICOMESH_IS_ERR(_rid_res))
            return PICOMESH_ERR(picomesh_size, "issues_issues_count_total: ensure remote id failed", _rid_res);
        uint32_t _rid = _rid_res.value;
        if (_rid == RPC_REMOTE_ID_UNRESOLVED)
        ...
        if (!_a || !_wbuf) {
            picomesh_allocator_free(_pool, _a);
            picomesh_allocator_free(_pool, _wbuf);
            return PICOMESH_ERR(picomesh_size, "issues_issues_count_total: wire scratch alloc failed");
        }
        size_t _off = 0;
        /* Client span for this downstream call. Minted BEFORE the header
         * bag is serialized so the wire carries this span as the remote
         ...
         * this client span's id as parent_span_id across the serialize. */
        {
            ...
            if (_hn == 0) {
                ...
                _ret = PICOMESH_ERR(picomesh_size, "issues_issues_count_total: header serialize overflow");
                goto _rpc_done;
            }
            _off = _hn;
        }
        {
            uint64_t _h = *(uint64_t *)((char *)obj + sizeof(*obj));
            if (_off + 8 > _acap)
                { ytelemetry_span_end(&_tsp, 0, "issues_issues_count_total: pack overflow"); _ret = PICOMESH_ERR(picomesh_size, "issues_issues_count_total: pack overflow"); goto _rpc_done; }
            memcpy(_a + _off, &_h, 8); _off += 8;
        }
        size_t _wn = rpc_call(_s->peer, RPC_OP_CALL, _rid, _a, _off,
                              _wbuf, 8197);
        ytelemetry_span_end(&_tsp, _wn >= 1 && _wbuf[0] == 0, NULL);
        if (_wn < 1) { _ret = PICOMESH_ERR(picomesh_size, "issues_issues_count_total: short RPC response"); goto _rpc_done; }
        if (_wbuf[0] != 0) {
            uint32_t _msg_len = 0;
            if (_wn >= 5) memcpy(&_msg_len, _wbuf + 1, 4);
            char _msg[8193];
            ...
            _ret = _msg[0]
                       ? PICOMESH_ERR_OWNED(picomesh_size, strdup(_msg))
                       : PICOMESH_ERR(picomesh_size, "issues_issues_count_total: remote error (no msg)");
            goto _rpc_done;
        }
        if (_wn != 1 + sizeof(size_t)) { _ret = PICOMESH_ERR(picomesh_size, "issues_issues_count_total: truncated RPC payload"); goto _rpc_done; }
        size_t _v;
        memcpy(&_v, _wbuf + 1, sizeof(_v));
        _ret = PICOMESH_OK(picomesh_size, _v); goto _rpc_done;
    _rpc_done:
...
struct picomesh_json_result issues_issues_list(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, int64_t offset, int64_t limit)
{
    ...
    if (_s && _s->peer) {
        if (peer_channel_is_msgpack(_s->peer)) {
            ...
            if (!peer_channel_msgpack_call(_s->peer, "issues.issues.list", hdrs,
                ...
                _mret = _merr[0]
                            ...
                            : PICOMESH_ERR(picomesh_json, "issues_issues_list: msgpack call failed");
            } else {
                struct picomesh_msgpack_buffer _mrb;
                cmp_ctx_t _mrr;
                picomesh_msgpack_reader_init(&_mrr, &_mrb, _mresp, _mrlen);
        ...
        struct picomesh_uint32_result _rid_res = peer_channel_ensure_remote_id(_s->peer, _slot);
        if (PICOMESH_IS_ERR(_rid_res))
            return PICOMESH_ERR(picomesh_json, "issues_issues_list: ensure remote id failed", _rid_res);
        uint32_t _rid = _rid_res.value;
        if (_rid == RPC_REMOTE_ID_UNRESOLVED)
        ...
        if (!_a || !_wbuf) {
            picomesh_allocator_free(_pool, _a);
            picomesh_allocator_free(_pool, _wbuf);
            return PICOMESH_ERR(picomesh_json, "issues_issues_list: wire scratch alloc failed");
        }
        size_t _off = 0;
        /* Client span for this downstream call. Minted BEFORE the header
         * bag is serialized so the wire carries this span as the remote
         ...
         * this client span's id as parent_span_id across the serialize. */
        {
            ...
            if (_hn == 0) {
                ...
                _ret = PICOMESH_ERR(picomesh_json, "issues_issues_list: header serialize overflow");
                goto _rpc_done;
            }
            _off = _hn;
        }
        {
            uint64_t _h = *(uint64_t *)((char *)obj + sizeof(*obj));
            if (_off + 8 > _acap)
                { ytelemetry_span_end(&_tsp, 0, "issues_issues_list: pack overflow"); _ret = PICOMESH_ERR(picomesh_json, "issues_issues_list: pack overflow"); goto _rpc_done; }
            memcpy(_a + _off, &_h, 8); _off += 8;
        }
        ...
        size_t _wn = rpc_call(_s->peer, RPC_OP_CALL, _rid, _a, _off,
                              _wbuf, 65536);
        ytelemetry_span_end(&_tsp, _wn >= 1 && _wbuf[0] == 0, NULL);
        if (_wn < 1) { _ret = PICOMESH_ERR(picomesh_json, "issues_issues_list: short RPC response"); goto _rpc_done; }
        if (_wbuf[0] != 0) {
            uint32_t _msg_len = 0;
            if (_wn >= 5) memcpy(&_msg_len, _wbuf + 1, 4);
            char _msg[8193];
            ...
            _ret = _msg[0]
                       ...
                       : PICOMESH_ERR(picomesh_json, "issues_issues_list: remote error (no msg)");
            goto _rpc_done;
        }
        if (_wn < 5) { _ret = PICOMESH_ERR(picomesh_json, "issues_issues_list: truncated string response"); goto _rpc_done; }
        uint32_t _slen;
        memcpy(&_slen, _wbuf + 1, 4);
        if (_wn < (size_t)5 + _slen) { _ret = PICOMESH_ERR(picomesh_json, "issues_issues_list: truncated string payload"); goto _rpc_done; }
        char *_sv = malloc((size_t)_slen + 1);
        if (!_sv) { _ret = PICOMESH_ERR(picomesh_json, "issues_issues_list: out of memory"); goto _rpc_done; }
    ...
    if (_s && _s->peer) {
        if (peer_channel_is_msgpack(_s->peer)) {
            ...
            if (!peer_channel_msgpack_call(_s->peer, "issues.issues.list_all", hdrs,
                ...
                _mret = _merr[0]
                            ? PICOMESH_ERR_OWNED(picomesh_json, strdup(_merr))
                            : PICOMESH_ERR(picomesh_json, "issues_issues_list_all: msgpack call failed");
            } else {
                struct picomesh_msgpack_buffer _mrb;
                cmp_ctx_t _mrr;
                picomesh_msgpack_reader_init(&_mrr, &_mrb, _mresp, _mrlen);
        ...
        struct picomesh_uint32_result _rid_res = peer_channel_ensure_remote_id(_s->peer, _slot);
        if (PICOMESH_IS_ERR(_rid_res))
            return PICOMESH_ERR(picomesh_json, "issues_issues_list_all: ensure remote id failed", _rid_res);
        uint32_t _rid = _rid_res.value;
        if (_rid == RPC_REMOTE_ID_UNRESOLVED)
        ...
        if (!_a || !_wbuf) {
            picomesh_allocator_free(_pool, _a);
            picomesh_allocator_free(_pool, _wbuf);
            return PICOMESH_ERR(picomesh_json, "issues_issues_list_all: wire scratch alloc failed");
        }
        size_t _off = 0;
        /* Client span for this downstream call. Minted BEFORE the header
         * bag is serialized so the wire carries this span as the remote
         ...
         * this client span's id as parent_span_id across the serialize. */
        {
            ...
            if (_hn == 0) {
                ...
                _ret = PICOMESH_ERR(picomesh_json, "issues_issues_list_all: header serialize overflow");
                goto _rpc_done;
            }
            _off = _hn;
        }
        {
            uint64_t _h = *(uint64_t *)((char *)obj + sizeof(*obj));
            if (_off + 8 > _acap)
                { ytelemetry_span_end(&_tsp, 0, "issues_issues_list_all: pack overflow"); _ret = PICOMESH_ERR(picomesh_json, "issues_issues_list_all: pack overflow"); goto _rpc_done; }
            memcpy(_a + _off, &_h, 8); _off += 8;
        }
        size_t _wn = rpc_call(_s->peer, RPC_OP_CALL, _rid, _a, _off,
                              _wbuf, 65536);
        ytelemetry_span_end(&_tsp, _wn >= 1 && _wbuf[0] == 0, NULL);
        if (_wn < 1) { _ret = PICOMESH_ERR(picomesh_json, "issues_issues_list_all: short RPC response"); goto _rpc_done; }
        if (_wbuf[0] != 0) {
            uint32_t _msg_len = 0;
            if (_wn >= 5) memcpy(&_msg_len, _wbuf + 1, 4);
            char _msg[8193];
            ...
            _ret = _msg[0]
                       ? PICOMESH_ERR_OWNED(picomesh_json, strdup(_msg))
                       : PICOMESH_ERR(picomesh_json, "issues_issues_list_all: remote error (no msg)");
            goto _rpc_done;
        }
        if (_wn < 5) { _ret = PICOMESH_ERR(picomesh_json, "issues_issues_list_all: truncated string response"); goto _rpc_done; }
        uint32_t _slen;
        memcpy(&_slen, _wbuf + 1, 4);
        if (_wn < (size_t)5 + _slen) { _ret = PICOMESH_ERR(picomesh_json, "issues_issues_list_all: truncated string payload"); goto _rpc_done; }
        char *_sv = malloc((size_t)_slen + 1);
        if (!_sv) { _ret = PICOMESH_ERR(picomesh_json, "issues_issues_list_all: out of memory"); goto _rpc_done; }
        if (_slen) memcpy(_sv, _wbuf + 5, _slen);
        _sv[_slen] = 0;
        _ret = PICOMESH_OK(picomesh_json, _sv); goto _rpc_done;
    _rpc_done:
...
struct picomesh_uint32_result issues_issues_repo_of(struct ctx * ctx, struct object * obj, struct yheaders * hdrs, uint32_t issue_id)
{
    ...
    if (_slot == METHOD_SLOT_UNDEFINED) {
        struct method_slot_result _sr =
            method_slot_get("issues", (method_id_t)issues_issues_repo_of);
        if (PICOMESH_IS_ERR(_sr))
            return PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: method_slot_get failed", _sr);
        _slot = _sr.value;
    }

    if (!obj) return PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: NULL object");
    ...
    if (_s && _s->peer) {
        if (peer_channel_is_msgpack(_s->peer)) {
            ...
            if (!_margs || !_mresp) {
                free(_margs); free(_mresp);
                return PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: out of memory");
            }
            struct picomesh_msgpack_buffer _mab;
            cmp_ctx_t _maw;
            picomesh_msgpack_writer_init(&_maw, &_mab, _margs, 16384);
            ...
            size_t _mrlen = 0;
            char _merr[8192] = {0};
            if (!peer_channel_msgpack_call(_s->peer, "issues.issues.repo_of", hdrs,
                                           _margs, _mab.offset, _mresp, 256,
                                           &_mrlen, _merr, sizeof(_merr))) {
                _mret = _merr[0]
                            ? PICOMESH_ERR_OWNED(picomesh_uint32, strdup(_merr))
                            : PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: msgpack call failed");
            } else {
                struct picomesh_msgpack_buffer _mrb;
                cmp_ctx_t _mrr;
                picomesh_msgpack_reader_init(&_mrr, &_mrb, _mresp, _mrlen);
            uint64_t _mv = 0;
            if (!cmp_read_uinteger(&_mrr, &_mv))
                _mret = PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: bad msgpack uint result");
            else _mret = PICOMESH_OK(picomesh_uint32, (uint32_t)_mv);
            }
            free(_margs); free(_mresp);
            return _mret;
        ...
        struct picomesh_uint32_result _rid_res = peer_channel_ensure_remote_id(_s->peer, _slot);
        if (PICOMESH_IS_ERR(_rid_res))
            return PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: ensure remote id failed", _rid_res);
        uint32_t _rid = _rid_res.value;
        if (_rid == RPC_REMOTE_ID_UNRESOLVED)
            return PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: remote id unresolved");
        /* Wire scratch comes from THIS THREAD's pool, not the stack: the arg
         * buffer (_a, _acap bytes) and response buffer (_wbuf) are large
         * (~16 KiB + up to 64 KiB), and a nested chain of in-process hops would
         * overflow the fixed-size coroutine stack if these were locals. Every
        ...
        if (!_a || !_wbuf) {
            picomesh_allocator_free(_pool, _a);
            picomesh_allocator_free(_pool, _wbuf);
            return PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: wire scratch alloc failed");
        }
        size_t _off = 0;
        /* Client span for this downstream call. Minted BEFORE the header
         * bag is serialized so the wire carries this span as the remote
         * peer's parent. */
        struct ytelemetry_span _tsp;
        ytelemetry_client_span_begin(&_tsp, hdrs, "rpc.issues_issues_repo_of");
        /* Headers section: the FRAMEWORK serializes the request-header
         * bag (uid, trace context, or anything a caller injected) ahead
         * of the packed business args. The skel parses it straight back
         * into the `hdrs` argument. ytelemetry_client_serialize_headers swaps in
         * this client span's id as parent_span_id across the serialize. */
        {
            size_t _hn = ytelemetry_client_serialize_headers(&_tsp, hdrs, _a, _acap);
            if (_hn == 0) {
                ytelemetry_span_end(&_tsp, 0, "issues_issues_repo_of: header serialize overflow");
                _ret = PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: header serialize overflow");
                goto _rpc_done;
            }
            _off = _hn;
        }
        {
            uint64_t _h = *(uint64_t *)((char *)obj + sizeof(*obj));
            if (_off + 8 > _acap)
                { ytelemetry_span_end(&_tsp, 0, "issues_issues_repo_of: pack overflow"); _ret = PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: pack overflow"); goto _rpc_done; }
            memcpy(_a + _off, &_h, 8); _off += 8;
        }
        if (_off + sizeof(issue_id) > _acap)
            { ytelemetry_span_end(&_tsp, 0, "issues_issues_repo_of: pack overflow"); _ret = PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: pack overflow"); goto _rpc_done; }
        ...
        size_t _wn = rpc_call(_s->peer, RPC_OP_CALL, _rid, _a, _off,
                              _wbuf, 8197);
        ytelemetry_span_end(&_tsp, _wn >= 1 && _wbuf[0] == 0, NULL);
        if (_wn < 1) { _ret = PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: short RPC response"); goto _rpc_done; }
        if (_wbuf[0] != 0) {
            uint32_t _msg_len = 0;
            if (_wn >= 5) memcpy(&_msg_len, _wbuf + 1, 4);
            char _msg[8193];
            ...
            _ret = _msg[0]
                       ? PICOMESH_ERR_OWNED(picomesh_uint32, strdup(_msg))
                       : PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: remote error (no msg)");
            goto _rpc_done;
        }
        if (_wn != 1 + sizeof(uint32_t)) { _ret = PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: truncated RPC payload"); goto _rpc_done; }
        uint32_t _v;
        memcpy(&_v, _wbuf + 1, sizeof(_v));
        _ret = PICOMESH_OK(picomesh_uint32, _v); goto _rpc_done;
    _rpc_done:
        ...
        impl_t fn = class_dispatch_lookup(object_class(obj), _slot);
        if (!fn) return PICOMESH_ERR(picomesh_uint32, "issues_issues_repo_of: no impl on this class");
        return ((issues_issues_repo_of_fn)fn)(ctx, obj, hdrs, issue_id);
    }
}
