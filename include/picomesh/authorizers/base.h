...
PICOMESH_RESULT_DECLARE(picomesh_authz_decision, struct picomesh_authz_decision);
...
struct picomesh_authorizer_ops {
    ...
    struct picomesh_authz_decision_result (*authorize)(void *state, const char *endpoint,
