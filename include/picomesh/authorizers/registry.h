...
picomesh_authorizer_build(struct picomesh_engine *engine,
...
picomesh_authorizer_decide(struct picomesh_authorizer *authorizer,
                           const char *endpoint, const struct json_value *args,
                           const char *jwt);
