...
/* ---- methods ---- */
struct picomesh_int_result registry_registry_register_service(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    const char *name, const char *instance_id, const char *host, uint32_t port);
struct picomesh_int_result
registry_registry_deregister_service(struct ctx *ctx, struct object *obj,
                                     struct yheaders *hdrs, const char *name,
                                     const char *instance_id);
struct picomesh_string_result registry_registry_resolve(struct ctx *ctx,
                                                        struct object *obj,
                                                        struct yheaders *hdrs,
                                                        const char *name);
struct picomesh_json_result
registry_registry_discover_service(struct ctx *ctx, struct object *obj,
                                   struct yheaders *hdrs, const char *name);
struct picomesh_json_result
registry_registry_list_services(struct ctx *ctx, struct object *obj,
                                struct yheaders *hdrs);
struct picomesh_size_result registry_registry_count(struct ctx *ctx,
                                                    struct object *obj,
                                                    struct yheaders *hdrs);
