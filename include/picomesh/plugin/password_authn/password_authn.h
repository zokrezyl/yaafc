...
/* ---- methods ---- */
struct picomesh_int_result
password_authn_password_authn_register(struct ctx *ctx, struct object *obj,
                                       struct yheaders *hdrs, uint32_t user_id,
                                       int64_t hash);
struct picomesh_int_result
password_authn_password_authn_authenticate(struct ctx *ctx, struct object *obj,
                                           struct yheaders *hdrs,
                                           uint32_t user_id, int64_t hash);
struct picomesh_int_result password_authn_password_authn_change_password(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs,
    uint32_t user_id, int64_t hash);
struct picomesh_size_result password_authn_password_authn_count_registered(
    struct ctx *ctx, struct object *obj, struct yheaders *hdrs);
struct picomesh_json_result
password_authn_password_authn_list(struct ctx *ctx, struct object *obj,
                                   struct yheaders *hdrs, int64_t offset,
                                   int64_t limit);
struct picomesh_json_result
password_authn_password_authn_list_all(struct ctx *ctx, struct object *obj,
                                       struct yheaders *hdrs);
